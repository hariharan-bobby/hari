            ...
            {mode !== 'forgot' && (
              <div className="mb-6 space-y-2.5">
                ...
                >
                  ...
                  <span>Continue with Google OAuth / Gmail</span>
                </button>

                <button
                  type="button"
                  onClick={() => handleGoogleSelectAccount('Hariharan B', 'gamertechtamilan@gmail.com')}
                  className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-slate-900 hover:bg-slate-800 text-white rounded-2xl text-xs font-semibold border border-slate-700 transition-all shadow-md"
                >
                  ...
                  <span>Sign In with GitHub (@hariharan-bobby)</span>
                </button>
